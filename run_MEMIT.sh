...
for DATA in "${DATAS[@]}";do
    for LANG in "${LANGS[@]}";do
        ...
        CUDA_VISIBLE_DEVICES=$CUDA python run_zsre_llama2.py --lang1 en --lang2 $LANG --editing_method MEMIT --hparams_dir ./hparams/MEMIT/llama-7b.yaml  --data_dir $DATA --ds_size 120
    done
done
